...
import {
  createInputBuffer
} from './buffer/InputBuffer.js';
import {
  createOutputBuffer
} from './buffer/OutputBuffer.js';
import {
  Caret,
  StackType,
  createStack
...
export function jsonrepairCore(_ref) {
  ...
  function skipEllipsis() {
    parseWhitespaceAndSkipComments();
    if (input.charCodeAt(i) === codeDot && input.charCodeAt(i + 1) === codeDot && input.charCodeAt(i + 2) === codeDot) {
